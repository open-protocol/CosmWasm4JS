...
export function readRegion(memory: WebAssembly.Memory, ptr: number, maxLength: number): Buffer {
...
export function writeRegion(memory: WebAssembly.Memory, ptr: number, data: Buffer): void {
  const region = getRegion(memory, ptr);
...
export function getRegion(memory: WebAssembly.Memory, ptr: number): Region {
...
export function setRegion(memory: WebAssembly.Memory, ptr: number, data: Region): void {
